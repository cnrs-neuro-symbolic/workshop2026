...
## CNRS Workshop *Neurosymbolic Methods and Their Applications in Data Science*
...
```
Tuesday, October 6, 2026, from 9:00 AM to 5:00 PM
...
The event is open to researchers and students interested in *artificial intelligence*, *data science*, and *neuro-symbolic approaches*. **Participation is free**, but **registration is mandatory**:

**[Registration form](https://forms.gle/XdKnMxs2F6oKtorj6)**

Poster submission:

Participants wishing to present a poster are invited to check the corresponding box during online registration. They will be contacted later with practical details regarding the submission.
